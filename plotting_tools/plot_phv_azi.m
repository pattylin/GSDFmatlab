...
%% Now start getting ready to plot at one location
% if chooselocation == 1
    ...
    for ip=1:length(periods)
        ...
        for iue = 1:length(uevent)
            ...
            if isnan(helmholtz(ip).GV_cor(uxi))==1;
                ...
                evphv(ip).event(iue) = helmholtz(ip).GV_cor(uxi);
            end
...
%         elseif length(htemp) == 7
%             legend(h,num2str(periods(htemp(1))),num2str(periods(htemp(2))),...
%                 num2str(htemp(3)),num2str(htemp(4)),num2str(htemp(5)),...
%                 num2str(htemp(6)),num2str(htemp(7)));
%         elseif length(htemp) == 6
%             legend(h,num2str(periods(htemp(1))),num2str(periods(htemp(2))),...
%                 num2str(htemp(3)),num2str(htemp(4)),num2str(htemp(5)),...
%                 num2str(htemp(6)));
%         elseif length(htemp) == 5
%             legend(h,num2str(periods(htemp(1))),num2str(periods(htemp(2))),...
%                 num2str(htemp(3)),num2str(htemp(4)),num2str(htemp(5)));
%         elseif length(htemp) == 4
%             legend(h,num2str(periods(htemp(1))),num2str(periods(htemp(2))),...
%                 num2str(htemp(3)),num2str(htemp(4)));
%         elseif length(htemp) == 3
%             legend(h,num2str(periods(htemp(1))),num2str(periods(htemp(2))),...
%                 num2str(htemp(3)));
        end
        drawnow;
